    ...
    public GameObject createBullet(BulletType type = BulletType.RANDOM)
    {
        ...
        switch(type)
        {
            case BulletType.REGULAR:
               ...
               tempBullet.GetComponent<BulletController>().damange = 10;
                break;
            case BulletType.FAT:
                tempBullet = Instantiate(fatBullet);
                tempBullet.GetComponent<BulletController>().damange = 20;
                break;
            case BulletType.PULSING:
                tempBullet = Instantiate(pulsingBullet);
                tempBullet.GetComponent<BulletController>().damange = 30;
                break;
        }
